	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			// THE PLAYER ATTACKS THE DRAGON
				...
				// or a kick
			String yellOrKick = JOptionPane.showInputDialog("Attack the dragon with a yell or a kick?");
...
JOptionPane.showMessageDialog(null, "Player health lost = "+dragonAttack+"\n Dragon health lost = "+playerAttack+"");
	...
	static void dragonLost() {
		...
		JOptionPane.showMessageDialog(null, "You beat the dragon and obtained 1 million gold!");
		System.exit(0);   //This code ends the program
	}
